...
function Blurb({ text = "", style }) {
  return (
    <div style={style} className="text-[#0e4749] font-medium text-xl max-w-lg">
      {text}
    </div>
  );
}
...
const MESSAGES = [
  "End-to-end feature ownership across startups and traditional industry — full-stack and ML internships",
  "Exploring agentic systems and multi-agent architectures",
  "Catch me skating, doing my nails, finishing a book, or knitting something new :)",
];
    ...
    <div className="w-full my-24">
      ...
      <div className="flex flex-row items-start justify-center mx-12 gap-16">
        <div className="space-y-6">
          ...
          >
            <p className="text-[#0e4749] ">Hi, I'm</p>
            <p className="font-semibold text-[#0e4749] text-4xl">Natalie Lim</p>
            <p className="text-[#0e4749] ">CS, AI @ UPenn</p>
          </div>
          <img
            ref={imgRef}
